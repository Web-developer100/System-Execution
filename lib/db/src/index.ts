...
if (process.env.DATABASE_URL) {
  ...
  try {
    ...
    const ddl = `
      ...
      CREATE TABLE IF NOT EXISTS wordlist_entries (id SERIAL PRIMARY KEY, path TEXT NOT NULL UNIQUE, category VARCHAR(50) NOT NULL DEFAULT 'general', severity VARCHAR(20) NOT NULL DEFAULT 'medium', description TEXT, active TEXT NOT NULL DEFAULT 'true', created_at TIMESTAMP DEFAULT NOW() NOT NULL)
    `;
